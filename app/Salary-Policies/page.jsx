...
const salaryPolicies = [
  ...
  [6, "8,100,000", "$40.50", "4.50%", "$4.05"],
  [7, "10,350,000", "$51.75", "6.00%", "$6.90"],
  [8, "13,500,000", "$67.50", "6.00%", "$9.00"],
  [9, "20,250,000", "$101.25", "7.50%", "$16.88"],
  [10, "24,750,000", "$123.75", "7.50%", "$20.63"],
  [11, "47,250,000", "$236.25", "9.00%", "$47.25"],
  [12, "60,750,000", "$303.75", "9.00%", "$60.75"],
  [13, "74,250,000", "$371.25", "10.50%", "$86.63"],
  [14, "101,700,000", "$508.50", "10.50%", "$118.65"],
  [15, "115,200,000", "$576.00", "12.00%", "$153.60"],
  [16, "135,000,000", "$675.00", "12.00%", "$180.00"],
  [17, "160,200,000", "$801.00", "13.50%", "$240.30"],
  [18, "202,500,000", "$1,012.50", "13.50%", "$303.75"],
  [19, "236,700,000", "$1,183.50", "15.00%", "$394.50"],
  [20, "337,500,000", "$1,687.50", "15.00%", "$562.50"]
];
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[800px] border-collapse text-left">
              ...
              <tbody className="divide-y divide-white/10 text-sm sm:text-base">
                {salaryPolicies.map(([level, target, hostSalary, agencyRate, agencyUsd]) => (
                  <tr key={level} className="transition-colors hover:bg-white/8">
                    ...
                    <td className="px-6 py-4 text-right text-white/45">—</td>
                  </tr>
                ))}
              </tbody>
            </table>
